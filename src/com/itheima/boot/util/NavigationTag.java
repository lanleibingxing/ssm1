    ...
    public int doStartTag() throws JspException {
        ...
        try {
        	...
        	if (page.getPage() > 1) {
                ...
                writer.print("<li><a href=\"" + preUrl + "\">涓婁竴椤�</a></li>");
            } else {
            	writer.print("<li class=\"disabled\"><a href=\"#\">涓婁竴椤�</a></li>");
            }
            ...
            if (page.getPage() < pageCount) {
                ...
                writer.print("<li><a href=\"" + nextUrl + "\">涓嬩竴椤�</a></li>");
            } else {
            	writer.print("<li class=\"disabled\"><a href=\"#\">涓嬩竴椤�</a></li>");
            }
            writer.print("</nav>");
        } catch (IOException e) {
            e.printStackTrace();
